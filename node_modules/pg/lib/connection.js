...
console.log("GNAGNA TEST readyState : " + this.stream.readyState);
  if(this.stream.readyState === 'closed') {
    this.stream.connect(port, host);
  } else if(this.stream.readyState == 'open') {
    this.emit('connect');
  }
console.log("GNAGNA TEST this : " + this);
  var self = this;
...
Connection.prototype.attachListeners = function(stream) {
  ...
  stream.on('data', function(buff) {
    ...
    console..log("hitting issue now data:  " + buff);
    while(packet) {
      console..log("hitting issue now:  " + packet);
